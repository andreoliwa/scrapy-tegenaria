...
class ImmobilienScout24Spider(Spider, SpiderMixin):
    ...
    def start_requests(self):
        ...
        return chain(self.read_emails(), super(ImmobilienScout24Spider, self).start_requests())
    ...
    def parse_item(self, response):
        ...
        item.add_xpath(
            "active",
            '//div[contains(@class, "status-message")]' '/h3[starts-with(normalize-space(.), "Angebot")]/text()',
        )
    ...
    def before_marshmallow(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "neighborhood" in data:
            ...
            data["neighborhood"] = " ".join(set(re.split(r"\W+", data["neighborhood"].strip(" ()"))))
